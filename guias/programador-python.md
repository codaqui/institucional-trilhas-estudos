...
- Inicialmente a trilha de conteúdos usadas foi do curso do Geek University, e posteriormente a [@melissarr](https://github.com/melissarr) fez um trabalho de agrupamento e pesquisa dessa trilha em diversos portais. A partir desse trabalho de agrupamento e pesquisa da [@melissarr](https://github.com/melissarr), [@pedrocvaranda](https://github.com/pedrocvaranda) organizou os tópicos "[Introdução à linguagem Python](https://github.com/codaqui/institucional-trilhas-estudos/blob/feature/programador-python/guias/programador-python.md#introdução-à-linguagem-python)", "[Variáveis e Tipos de Dados em Python](https://github.com/codaqui/institucional-trilhas-estudos/blob/feature/programador-python/guias/programador-python.md#variáveis-e-tipos-de-dados-em-python)", "[Estruturas Lógicas e Condicionais em Python](https://github.com/codaqui/institucional-trilhas-estudos/blob/feature/programador-python/guias/programador-python.md#estruturas-lógicas-e-condicionais-em-python)" e "[Estruturas de Repetição em Python](https://github.com/codaqui/institucional-trilhas-estudos/blob/feature/programador-python/guias/programador-python.md#estruturas-de-repetição-em-python)".
